...
const translations = {
  fr: {
    ...
    archived_rooms: "Salles archivées",
    pull_to_refresh: "Tirer pour actualiser",
    resubmit: "Resoumettre",
    resubmit_confirm: "Supprimer votre soumission et resoumettre ?",
    allow_resubmission: "Autoriser la resoumission",
    bulk_grade: "Correction en lot",
    bulk_delete: "Supprimer en lot",
  ...
  en: {
    ...
    archive: "Archive",
    unarchive: "Unarchive",
    archived_rooms: "Archived Rooms",
    pull_to_refresh: "Pull to refresh",
    resubmit: "Resubmit",
    resubmit_confirm: "Delete your submission and resubmit?",
  ...
  ar_tn: {
    ...
    search_rooms: "ابحث في القاعات...",
    no_results: "ما فماش نتائج",
    archived: "مؤرشفة",
    archive: "أرشف",
    unarchive: "رجّع من الأرشيف",
    archived_rooms: "القاعات المؤرشفة",
    pull_to_refresh: "اسحب للتحديث",
    resubmit: "عاود سلّم",
    resubmit_confirm: "تمسح التسليم وتعاود؟",
    allow_resubmission: "سماح بإعادة التسليم",
    bulk_grade: "تصحيح جماعي",
