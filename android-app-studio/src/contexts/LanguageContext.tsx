...
const translations = {
  fr: {
    ...
    teacher_grades_desc: "L'aperçu des notes est pour les étudiants. Voir les notes dans chaque salle.",
  ...
  en: {
    ...
    teacher_grades_desc: "Grade overview is available for students. View grades in each room's assignments.",
