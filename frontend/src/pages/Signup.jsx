      ...
      >
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          >
            ...
            <h2 style={{ fontSize: 20, fontFamily: "var(--font-serif)" }}>
              Kelebia Classroom
            </h2>
          </Link>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <div
                style={{
                  flex: 1,
                  padding: 16,
                  border: `1px solid ${form.role === "teacher" ? "var(--text-primary)" : "var(--border)"}`,
              ...
              <div
                style={{
                  flex: 1,
                  padding: 16,
                  border: `1px solid ${form.role === "student" ? "var(--text-primary)" : "var(--border)"}`,
                  borderRadius: "var(--radius-sm)",
                  cursor: "pointer",
                  textAlign: "center",
                  transition: "var(--transition)",
          ...
          <div className="form-group">
            ...
            {form.password && (
              <div className="password-strength" style={{ marginTop: 8 }}>
                ...
                <div
                  className={`password-strength-text ${strength.color}`}
          ...
          <div className="form-group">
            ...
            />
            {passwordsMatch && (
              <div className="form-success">{t("signup.passwordsMatch")}</div>
            )}
            {passwordsMismatch && (
              <div className="form-error">{t("signup.passwordsMismatch")}</div>
            )}
